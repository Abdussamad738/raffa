...
function _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; } // import { mockDataTeam } from '../data/mockData.js';
var Users = function Users() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.delete("/users/".concat(id));
          case 3:
  ...
  var handleUpdateUser = function handleUpdateUser(id) {
  ...
  (0, _react.useEffect)(function () {
    var fetchUsers = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var response, data, formattedUsers;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return fetch("".concat(backendUrl, "/users/all"), {
                headers: {
            ...
            case 6:
              data = _context2.sent;
              formattedUsers = data.map(function (user) {
                return {
                  id: user._id,
                  name: user.name,
                  email: user.email,
              ...
              dispatch((0, _userActions.setAllUsers)(data)); // Dispatch the action to update the user state
  ...
  // },
  {
    ...
    renderCell: function renderCell(_ref3) {
      ...
      return /*#__PURE__*/_react.default.createElement(_material.Box, {
        ...
        backgroundColor: role === "admin" ? colors.greenAccent[600] : role === "manager" ? colors.greenAccent[700] : colors.greenAccent[700],
        borderRadius: "4px"
      }, role === "admin" && /*#__PURE__*/_react.default.createElement(_AdminPanelSettingsOutlined.default, null), role === "manager" && /*#__PURE__*/_react.default.createElement(_SecurityOutlined.default, null), role === "user" && /*#__PURE__*/_react.default.createElement(_LockOpenOutlined.default, null), /*#__PURE__*/_react.default.createElement(_material.Typography, {
    ...
    renderCell: function renderCell(_ref4) {
      ...
      }, /*#__PURE__*/_react.default.createElement(_iconsMaterial.DeleteOutline, {
        color: "error"
      })), /*#__PURE__*/_react.default.createElement(_material.IconButton, {
        onClick: function onClick() {
          return handleUpdateUser(row.id);
        }
...
var _default = (0, _reactRedux.connect)(mapStateToProps)(Users);
