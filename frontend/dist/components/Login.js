...
function Login() {
  ...
  var onSubmit = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(values) {
      var response, cart, userData, _err$response;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post("".concat(backendUrl, "/users/login"), values);
          case 3:
            ...
            cart = response.data.user.cart; // Dispatch the setCart action to set the cart in the Redux store
            cart.forEach(function (item) {
              dispatch((0, _productActions.addToCart)(item.productDetails));
            });
            userData = response.data;
            console.log(userData);
            dispatch((0, _userActions.setUser)(userData, response.data.token));
            // if (userData) {
  ...
  return /*#__PURE__*/_react.default.createElement(_commons.Container, null, /*#__PURE__*/_react.default.createElement(_commons.InnerContainer, null, /*#__PURE__*/_react.default.createElement("form", {
    onSubmit: formik.handleSubmit
  }, /*#__PURE__*/_react.default.createElement(_typography.HeadingXXLarge, null, "Sign In"), error && /*#__PURE__*/_react.default.createElement(_commons.ErrorText, null, error), /*#__PURE__*/_react.default.createElement(_input.Input, {
    name: "email",
    ...
    type: "submit",
    className: "btn-login"
  }, "Login"), /*#__PURE__*/_react.default.createElement(_button.Button, {
    size: "large",
